            ...
            <div className="col-lg-5 col-md-6" style={{ paddingLeft: "30px" }}>
              <div className="product_description">
                ...
                <div className="addToCart d-flex justify-content-between align-items-center">
                  <button className="btn btn-danger" style={{backgroundColor: "red"}} onClick={() => handleAddToCart(singleProduct)}>
                    Add To Cart
                  </button> 
                </div>
              </div>
...
<div className="comments_section mt-4">
  ...
  {currentUser ? (  
    <form onSubmit={handleCommentSubmit} className="mb-3">
      <textarea 
        ...
        required 
      />
      <button type="submit" className="btn btn-primary mt-2" style={{backgroundColor: "#2E2E2E"}}>Submit</button>
    </form>
  ) : (
    <p>
  ...
  {comments.length > 0 && (
    <div className="comments_list p-3" style={{ borderRadius: "8px", maxWidth: "1250px", margin: "auto", backgroundColor: "#f9f9f9", boxShadow: "0 4px 8px rgba(0,0,0,0.1)" }}>
